...
public class Attendingresponse {
	...
	public void Userresponse() {
		...
		// Verify user able to Respond as  attending 
		...
		.when()
		.get("/services/event/v1/event/c97vkc8r67nih8v3ul1g/attendees?limit=10&offset=0&status=all&response=attending")
		.then()
		.log().all();
